...
from app.models.alerts import Alert, AlertRule, AlertType, AlertPriority, UserAlertPreference
...
# Blueprint
alerts_new_bp = Blueprint('alerts_new', __name__, url_prefix='/alerts')
...
def get_user_alerts():
    ...
    try:
        ...
        # Senão, renderizar template (se existir)
        try:
...
@alerts_new_bp.route('/<int:alert_id>/read', methods=['POST'])
@login_required
...
@alerts_new_bp.route('/<int:alert_id>/dismiss', methods=['POST'])
@login_required
...
@alerts_new_bp.route('/create', methods=['POST'])
@login_required
...
@alerts_new_bp.route('/preferences')
@login_required
...
@alerts_new_bp.route('/preferences', methods=['POST'])
@login_required
...
@alerts_new_bp.route('/process', methods=['POST'])
@login_required
